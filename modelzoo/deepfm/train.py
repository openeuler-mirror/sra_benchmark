...
def main(tf_config=None, server=None):
    ...
    # set directory path
    model_dir = os.path.join(args.output_dir, 'model_DeepFM')
    ...
    if args.mode == "evaluate":
        ...
        with open(os.path.join(args.output_dir, "deepfm_throughput_record.txt"), "a+") as f:
            f.writelines(f"deepfm: {throughput}" + "\n")
