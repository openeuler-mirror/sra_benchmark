...
USER_COLUMN = [
    ...
    # 'tag_category_list', 'tag_brand_list'  # 屏蔽变长特征
]
ITEM_COLUMN = [
...
def main(tf_config=None, server=None):
    ...
    model_dir = os.path.join(args.output_dir, 'model_DSSM')
    ...
    if args.mode == "evaluate":
        ...
        with open(os.path.join(args.output_dir, "dssm_throughput_record.txt"), "a+") as f:
            f.writelines(f"dssm: {throughput}" + "\n")
